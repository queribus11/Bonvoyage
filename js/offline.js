...
(function () {
  ...
  function cacheTrip(cur) {
    ...
    LS.set(tripKey(cur.trip.id), { savedAt: Date.now(), trip: cur.trip, days: cur.days, tracks: cur.tracks, media: cur.media, comments: cur.comments, stops: cur.stops, camps: cur.camps });
  }
