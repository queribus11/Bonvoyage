...
Bouton **▶** parmi les outils de la carte (et « Revoir le voyage » sur la page des proches) : la caméra suit le parcours jour par jour, l'itinéraire se dessine, les photos apparaissent au passage et Valdo, la valise qui marche, avance sur la trace. « Arrêter » revient à la vue d'ensemble. Sur la carte, chaque journée est repérée par sa pastille « Jour 1 », « Jour 2 »… de la même couleur que dans le récit.
