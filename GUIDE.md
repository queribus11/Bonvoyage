...
### Journée sans trace GPS : le trajet estimé et le moyen de locomotion
Si une journée n'a que des photos (un carnet rempli après coup, par exemple), la carte relie leurs positions **en pointillés**, dans l'ordre de l'heure de prise de vue. Dans la fiche de la journée, **« Comment as-tu voyagé ce jour-là ? »** fixe le moyen de locomotion de la journée (à pied, vélo, voiture, bus, train, bateau, kayak, avion, moto). S'il change en cours de route (arrivée au parking, départ de la rando, embarquement), indique-le sur la photo prise à ce moment-là : **« À partir de cette photo, je voyage… »** dans la fiche de la photo, ou la liste dépliable « Changements en cours de journée » de la fiche de la journée. Chaque tronçon prend le moyen en cours jusqu'au prochain changement — un aller-retour ou trois moyens dans la même journée se règlent ainsi avec deux ou trois photos bien choisies : l'avion trace un arc, une petite icône du moyen de transport s'affiche sur la vignette, et Valdo avance plus ou moins vite pendant le survol, avec le véhicule à côté de lui. Laisse « idem » quand rien ne change depuis la photo précédente : tu ne règles que les changements.
Pour que la voiture, le bus ou le vélo suivent les **vraies routes**, ouvre la fiche de la journée et touche **Tracer l'itinéraire par la route** : l'app demande le chemin à un service d'itinéraire gratuit (OSRM) et l'enregistre comme trace « itinéraire estimé » (la fiche affiche sa longueur et un bouton *Retirer* ; la trace est aussi dans l'onglet GPS). Refais « Tracer » si tu changes un moyen de locomotion. Ce service public est parfois lent ou indisponible : réessaie plus tard si ça échoue.

### Le survol : Valdo sur le parcours
Bouton **Revoir** parmi les outils de la carte (et « Suivre le parcours » sur la page des proches) : la caméra suit le parcours jour par jour, l'itinéraire se dessine, les photos apparaissent au passage et Valdo avance sur la trace — à pied, ou à bord de son véhicule (voiture, bus, train, bateau, kayak, avion, vélo, scooter). Chaque journée dure au plus vingt secondes ; **Pause**, **Suivant** (journée suivante) et **Arrêter** sont dans le bandeau ; la vitesse (🐢 / ▶ / 🐇) est un réglage du voyage qui s'applique aussi à tes proches. À la fin, tes proches voient une carte-bilan (jours, kilomètres, photos) et une invitation à laisser un mot. Si le téléphone est réglé « réduire les animations », la caméra reste posée (vue du dessus, sans rotation). Sur la carte, chaque journée est repérée par sa pastille « Jour 1 », « Jour 2 »… de la même couleur que dans le récit.
...
Onglet **Journées** : touche une journée et tu la *vois* d'abord — la carte l'isole et Valdo la parcourt avec le bon moyen de transport — puis la carte flottante « Jour 5 » propose **Photos & récit** (la fiche : photos de la journée avec un bouton pour en ajouter, puis récit écrit et audio, trajet, publication) et **Tout le voyage** pour revenir à la vue générale ; les photos ajoutées à une journée déjà publiée sont visibles tout de suite ; touche son numéro coloré pour la voir seule sur la carte. Les paragraphes sont conservés. Sous le texte, **🎙 Enregistrer le récit du jour** te permet de dicter ton récit (bouton ■ Arrêter pour terminer, puis *Refaire* ou *Supprimer*). Tu peux tout modifier plus tard, même des années après.
