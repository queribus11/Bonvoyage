-- Bonvoyage v9 — mise à jour de la base (Supabase > SQL Editor > Run). Sans risque, relançable.
-- Regroupe les ajouts depuis la v8 : lieu et moyen de locomotion des journées, moyen de locomotion des photos, vitesse du survol.
